...
from app.supabase_conn import (
    get_supabase_client, health, get_user_by_tid, 
    upsert_user_via_rpc, set_premium_via_rpc, revoke_premium, 
    set_credits, stats_totals, is_premium_active
)
SUPABASE_AVAILABLE = True
print("✅ Supabase handlers loaded successfully")
except ImportError as e:
    SUPABASE_AVAILABLE = False
    print(f"⚠️ Could not register Supabase commands: {e}")

    # Define dummy functions to prevent crashes
    def get_user_by_tid(tg_id): return None
    def upsert_user_via_rpc(*args, **kwargs): return None
    def set_premium_via_rpc(*args, **kwargs): None
    def revoke_premium(*args, **kwargs): None
    def set_credits(*args, **kwargs): None
    def stats_totals(): return 0, 0
    def is_premium_active(tg_id): return False
    def health(): return False, "Not available"
