...
def upsert_user_with_ref_optional(
    ...
    if require_ref:
        return upsert_user_ref_required(tg_id, username, first_name, last_name, referred_by)

    # Optional referral mode
    if referred_by and referred_by != tg_id and ref_exists(referred_by):
        # Valid referral provided
        pass
    else:
        # No valid referral, set to None
        referred_by = None
