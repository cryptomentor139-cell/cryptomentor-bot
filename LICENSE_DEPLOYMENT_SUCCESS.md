...
## Credentials untuk Teman (UID: 1234500014)
...
data = {
    'wl_id': '<REDACTED_UUID>',
    'secret_key': '<REDACTED_WL_SECRET_KEY>'
}
...
# Run billing
cd /root/cryptomentor-bot/license_server
venv/bin/python3 -c "import asyncio; from license_manager import LicenseManager; asyncio.run(LicenseManager().debit_billing('<REDACTED_UUID>'))"
```
