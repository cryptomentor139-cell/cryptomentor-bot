...
print("Searching for final startup confirmation...")
stdin, stdout, stderr = ssh.exec_command("journalctl -u cryptomentor.service -n 200 --no-pager | grep -E 'AutoSignal|Scheduler' | tail -n 20")
