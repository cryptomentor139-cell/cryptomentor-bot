...
print("Searching for scheduler logs in last 500 lines...")
stdin, stdout, stderr = ssh.exec_command("journalctl -u cryptomentor.service -n 500 --no-pager | grep -E 'AutoSignal|scheduler' | tail -n 20")
