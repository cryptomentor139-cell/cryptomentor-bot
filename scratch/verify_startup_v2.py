...
print("Searching for [ROCKET] and [AutoSignal] in last 300 lines...")
stdin, stdout, stderr = ssh.exec_command("journalctl -u cryptomentor.service -n 300 --no-pager | grep -E '\\[ROCKET\\]|\\[AutoSignal\\]'")
