...
print("Searching for [AutoSignal] in last 300 lines (post-sync)...")
stdin, stdout, stderr = ssh.exec_command("journalctl -u cryptomentor.service -n 300 --no-pager | grep 'AutoSignal'")
