...
print("Searching for the print message...")
stdin, stdout, stderr = ssh.exec_command("journalctl -u cryptomentor.service _PID=684479 | grep 'AutoSignal broadcast engine started'")
