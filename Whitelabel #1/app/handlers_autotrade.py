...
import os as _os
BITUNIX_REFERRAL_CODE = _os.getenv("BITUNIX_REFERRAL_CODE", "sq45")
BITUNIX_REFERRAL_URL  = _os.getenv(
    "BITUNIX_REFERRAL_URL",
    f"https://www.bitunix.com/register?vipCode={BITUNIX_REFERRAL_CODE}"
)
