...
- [ ] 1. Setup struktur proyek dan konfigurasi dasar
  ...
  - Buat `marketing/agent/requirements.txt` dengan dependensi: `supabase`, `openai`, `httpx`, `hypothesis`, `python-dotenv`, `apscheduler`
  - Buat `marketing/agent/config.py` yang membaca semua environment variables (Instagram, Facebook, TikTok, AI providers, Supabase, Telegram) dan memvalidasi ketersediaannya saat startup — tampilkan daftar env var yang hilang jika ada yang tidak ditemukan
...
- [ ] 2. Implementasi database schema dan koneksi Supabase
  - [ ] 2.1 Buat `marketing/agent/db/setup_marketing.sql` dengan semua tabel: `marketing_campaigns`, `marketing_content`, `marketing_publications`, `marketing_leads`, `marketing_lead_interactions`, `marketing_analytics`, `marketing_ab_tests`, `marketing_audience_personas`, `marketing_research_topics`
  ...
  - [ ]* 2.2 Tulis property test untuk round-trip status konten
    - **Properti 11: Round-Trip Status Konten**
    - **Memvalidasi: Persyaratan 5.7**

- [ ] 3. Implementasi Content Engine dan Audience Intelligence (core)
  - [ ] 3.1 Buat `marketing/agent/core/audience_intelligence.py` dengan class `AudienceIntelligence`
  ...
  - [ ]* 3.2 Tulis property test untuk klasifikasi persona
    - **Properti 5: Invariant Klasifikasi Persona**
    - **Memvalidasi: Persyaratan 13.1**

  - [ ]* 3.3 Tulis property test untuk klasifikasi segment
    - **Properti 6: Invariant Klasifikasi Segment**
    - **Memvalidasi: Persyaratan 13.2, 18.5**

  - [ ] 3.4 Buat `marketing/agent/core/content_engine.py` dengan class `ContentEngine`
...
- [ ] 5. Implementasi Strategist Agent
  - [ ] 5.1 Buat `marketing/agent/agents/strategist_agent.py` dengan class `StrategistAgent`
  ...
  - [ ]* 5.2 Tulis property test untuk kategori topik riset
    - **Properti 9: Invariant Kategori Topik**
    - **Memvalidasi: Persyaratan 2.3**

  - [ ]* 5.3 Tulis property test untuk jumlah topik riset
    - **Properti 13: Invariant Jumlah Topik Riset**
    - **Memvalidasi: Persyaratan 2.2**

- [ ] 6. Implementasi Content Agent
  - [ ] 6.1 Buat `marketing/agent/agents/content_agent.py` dengan class `ContentAgent`
...
- [ ] 8. Implementasi Publishers (4 platform)
  - [ ] 8.1 Buat `marketing/agent/publishers/instagram_publisher.py`
  ...
  - [ ] 8.2 Buat `marketing/agent/publishers/facebook_publisher.py`
  ...
  - [ ] 8.3 Buat `marketing/agent/publishers/tiktok_publisher.py`
  ...
  - [ ] 8.4 Buat `marketing/agent/publishers/threads_publisher.py`
...
- [ ] 9. Implementasi A/B Testing dan Lead Capture (core)
  - [ ] 9.1 Buat `marketing/agent/core/ab_testing.py` dengan class `ABTestManager`
  ...
  - [ ]* 9.2 Tulis property test untuk keputusan Scale/Kill
    - **Properti 12: Keputusan Scale/Kill yang Konsisten**
    - **Memvalidasi: Persyaratan 16.6, 20.2, 20.3**

  - [ ] 9.3 Buat `marketing/agent/core/lead_capture.py` dengan class `LeadCaptureManager`
...
- [ ] 10. Implementasi Distribution Agent
...
- [ ] 14. Implementasi Approval Queue dan notifikasi Telegram
...
- [ ] 15. Implementasi Content Calendar dan penjadwalan otomatis
...
- [ ] 16. Implementasi Brand Context reload dan Orchestrator utama
  - [ ] 16.1 Buat `marketing/agent/main.py` dengan class `MarketingOrchestrator`
  ...
  - [ ] 16.2 Implementasi Brand Context reload tanpa restart
  ...
  - [ ]* 16.3 Tulis property test untuk Brand Context reload
