...
export interface AgentLoopOptions {
  ...
  skills?: Skill[];
  paymentSystem?: any; // PaymentApprovalSystem from payment/approval.ts
...
export async function runAgentLoop(
  ...
  const { identity, config, db, conway, inference, social, skills, paymentSystem, onStateChange, onTurnComplete } =
    options;
