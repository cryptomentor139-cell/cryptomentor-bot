...
Deploy your automaton to Railway for 24/7 operation with Telegram bot control:

### Quick Deploy

1. Fork this repository
2. Create a [Railway](https://railway.app) project from your fork
...
TELEGRAM_BOT_TOKEN=your_bot_token  # Optional but recommended
TELEGRAM_CREATOR_ID=your_telegram_id
```
...
- `/approve <id>` - Approve payment requests
- Natural conversation with your automaton
- Real-time payment notifications

See [Railway Deployment Guide](docs/railway-deployment.md) for complete setup instructions.
